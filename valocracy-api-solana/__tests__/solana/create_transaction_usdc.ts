...
describe("TRANSACTION", () => {
    ...
    it("SEND TRANSACTION", async () => {
        ...
        const vaultBalance = await connection.getBalance(vault_public_key, "processed");
        console.log('vaultBalance', vaultBalance / LAMPORTS_PER_SOL);
        ...
        const transferSolIx = await SystemProgram.transfer({
            ...
            lamports: 0.001*LAMPORTS_PER_SOL, // send .5 SOL 
        });
