...
class RegistryService {
	...
	private getMailCodeHtmlBody(data: any) {
		...
		`;
		// const securityInfo = `Por segurança, essa requisição foi enviada pelo dispositivo ${data.operating_system || ''} usando ${data.browser_name || ''}. `;
						...
						<tr>
						  <td class="content-cell">
							<div class="f-fallback">
							  ...
							  <p>Use o código de seguranca a seguir para prosseguir o cadastro da conta <b>${data.email}</b> no <b>Valocracia</b>.</strong></p>
							  <!-- Action -->
	...
	async sendMailCode(data: any) {
		...
		const text = `Use o código de seguranca a seguir para prosseguir o cadastro da conta ${emailMasked} no Valocracia\n\n${data.code}\n\nAbraços,\nEquipe Valocracia`;
